                ...
                <Card className='mt-3 card-custom'>
                                        ...
                                        <>
                                            {
                                                relationships.length > 0 && relationships.some(
                                                    ...
                                                    <Button className='border-0 d' onClick={() => hanldeFollow(item.userId)}>
                                                        <i className="bi bi-person-dash"></i>{t("unfollow")}
                                                    </Button>
                                                    :
                                                    <Button className='border-0 d' onClick={() => hanldeFollow(item.userId)}>
                                                        <i className="bi bi-person-plus"></i>{t("follow")}
                                                    </Button>
                                            }
                                        </> : null
                                    }
                                    <CopyToClipboard text={`${'http://localhost:3000'}/post/${item.id}`} onCopy={handleCopy} >
                    ...
                    <div className={`card-body theme-${item.theme}`}>
                        <ShowMoreText
                            ...
                            width={0}
                        >
                            <div className='col-12'>{item.contents}</div>
                        </ShowMoreText>
